...
Use this section for schema-level documentation, request and response payloads, parameters, and operation details.
...
- [Delayed settlement (T+1)](./delayed-settlement.md)
